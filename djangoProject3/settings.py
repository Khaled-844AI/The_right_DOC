...
SECRET_KEY = 'django-insecure-ukg=ze*_i3z2kf)+aj6=qvh0=r!ak*o2)l=xdt-l^u31os2kvm'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'The_right_DOC/templates']
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
RECAPTCHA_PUBLIC_KEY = '6Lc4d6IpAAAAABOeb2Tr8xm4baf60mQNkcHG5fxU'
RECAPTCHA_PRIVATE_KEY = '6Lc4d6IpAAAAAACcVKBWGforGUmqzgsgdYRQaglR'